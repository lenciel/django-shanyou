...
MEDIA_APP_PREFIX = 'cdshanyou'

# the snapshot folder name under MEDIA_ROOT
MEDIA_APP_SNAPSHOT = 'snapshots'
...
if not os.path.exists(MEDIA_ROOT):
    ...
    os.mkdir(os.path.join(MEDIA_ROOT, MEDIA_APP_SNAPSHOT))
...
STATIC_DEFAULT_AVATAR_URL = STATIC_URL + 'customer/img/default_avatar.png'
